<template>
    <AdminLayout title="Add ordinance">
        <template #header>
                ...
                <section class="container mx-auto p-6">
                    ...
                    >
                        <div class="w-full shadow p-5 bg-gray-800">
                            <form @submit.prevent="storeOrdinance">
